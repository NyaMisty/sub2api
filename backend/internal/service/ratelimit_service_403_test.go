...
func (r *runtimeBlockRecorder) BlockAccountSchedulingWithContext(ctx context.Context, account *Account, until time.Time, reason string) {
	r.accounts = append(r.accounts, account)
	r.until = append(r.until, until)
	r.reasons = append(r.reasons, reason)
}

func (r *runtimeBlockRecorder) ClearAccountSchedulingBlockWithContext(ctx context.Context, accountID int64) {
